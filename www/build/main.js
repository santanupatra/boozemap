...
var AuthServiceProvider = /** @class */ (function () {
    ...
    AuthServiceProvider.prototype.getboozelist = function (data) {
        return this.http.post(this.apiUrl + 'products/boozelist.json', data).map(function (res) {
            return res.json();
        });
    };
    AuthServiceProvider.prototype.getsubboozelist = function (data) {
        return this.http.post(this.apiUrl + 'products/subboozelist.json', data).map(function (res) {
            return res.json();
        });
    };
    AuthServiceProvider.prototype.getproductlist = function (data) {
        return this.http.post(this.apiUrl + 'products/productlist.json', data).map(function (res) {
            return res.json();
        });
    };
    AuthServiceProvider.prototype.getproductdetails = function (data) {
        return this.http.post(this.apiUrl + 'products/productDetails.json', data).map(function (res) {
            return res.json();
        });
    };
